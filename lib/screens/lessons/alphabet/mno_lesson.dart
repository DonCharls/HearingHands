...
class MNOLesson extends StatefulWidget {
  const MNOLesson({super.key});

  @override
  State<MNOLesson> createState() => _MNOLessonState();
}

class _MNOLessonState extends State<MNOLesson> {
  ...
  final List<Map<String, String>> letters = [
    {
      "letter": "M",
      "word": "Monkey 🐒",
      "video": "https://youtube.com/example-m"
    },
    {
      "letter": "N",
      "word": "Nest 🪺",
      "video": "https://youtube.com/example-n"
    },
    {
      "letter": "O",
      "word": "Orange 🍊",
      "video": "https://youtube.com/example-o"
    },
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Image.asset('assets/images/mnolesson.png',
              height: 180, fit: BoxFit.contain),
          const SizedBox(height: 32),
          const Text(
            "Learn how to sign M, N, and O!",
      ...
      children: [
        const Text("Practice Time! 🧠",
            style: TextStyle(
                ...
                color: Colors.black87)),
        const SizedBox(height: 16),
        const Text("Try copying the hand signs for M, N, and O.",
            textAlign: TextAlign.center,
  ...
  Widget _buildCompletionSlide() {
    return _buildCenteredContent(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        const Text("🎉 You’ve completed MNO!",
            style: TextStyle(
                fontSize: 22,
                fontWeight: FontWeight.bold,
                color: Colors.black87)),
        const SizedBox(height: 12),
        const Text("Great job learning M, N, and O!",
            textAlign: TextAlign.center,
            style: TextStyle(color: Colors.black87)),
        const SizedBox(height: 32),
        LessonButton(
