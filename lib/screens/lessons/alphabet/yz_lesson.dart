...
class YZLesson extends StatefulWidget {
  const YZLesson({super.key});

  @override
  State<YZLesson> createState() => _YZLessonState();
}

class _YZLessonState extends State<YZLesson> {
  ...
  final List<Map<String, String>> letters = [
    {
      "letter": "Y",
      "word": "Yacht ⛵",
      "video": "https://youtube.com/example-y"
    },
    {
      "letter": "Z",
      "word": "Zebra 🦓",
      "video": "https://youtube.com/example-z"
    },
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Image.asset('assets/images/yzlesson.png',
              height: 180, fit: BoxFit.contain),
          const SizedBox(height: 32),
          const Text(
            "Learn how to sign Y and Z!",
      ...
      children: [
        const Text("Practice Time! 🧠",
            style: TextStyle(
                ...
                color: Colors.black87)),
        const SizedBox(height: 16),
        const Text("Try copying the hand signs for Y and Z.",
            textAlign: TextAlign.center,
  ...
  Widget _buildCompletionSlide() {
    return _buildCenteredContent(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        const Text("🎉 You’ve completed YZ!",
            style: TextStyle(
                fontSize: 22,
                fontWeight: FontWeight.bold,
                color: Colors.black87)),
        const SizedBox(height: 12),
        const Text("Congratulations! You’ve learned the entire alphabet.",
            textAlign: TextAlign.center,
            style: TextStyle(color: Colors.black87)),
        const SizedBox(height: 32),
        LessonButton(
