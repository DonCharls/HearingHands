...
class STULesson extends StatefulWidget {
  const STULesson({super.key});

  @override
  State<STULesson> createState() => _STULessonState();
}

class _STULessonState extends State<STULesson> {
  final PageController _controller = PageController();
  int _currentIndex = 0;
  static const Color primaryGreen = Color(0xFF58C56E);

  final List<Map<String, String>> letters = [
    {"letter": "S", "word": "Sun 🌞", "video": "https://youtube.com/example-s"},
    {
      "letter": "T",
      "word": "Tree 🌳",
      "video": "https://youtube.com/example-t"
    },
    {
      "letter": "U",
      "word": "Umbrella ☂️",
      "video": "https://youtube.com/example-u"
    },
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Image.asset('assets/images/stulesson.png',
              height: 180, fit: BoxFit.contain),
          const SizedBox(height: 32),
          const Text(
            "Learn how to sign S, T, and U!",
      ...
      children: [
        const Text("Practice Time! 🧠",
            style: TextStyle(
                ...
                color: Colors.black87)),
        const SizedBox(height: 16),
        const Text("Try copying the hand signs for S, T, and U.",
            textAlign: TextAlign.center,
  ...
  Widget _buildCompletionSlide() {
    return _buildCenteredContent(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        const Text("🎉 You’ve completed STU!",
            style: TextStyle(
                fontSize: 22,
                fontWeight: FontWeight.bold,
                color: Colors.black87)),
        const SizedBox(height: 12),
        const Text("Great job learning S, T, and U!",
            textAlign: TextAlign.center,
            style: TextStyle(color: Colors.black87)),
        const SizedBox(height: 32),
        LessonButton(
            label: "Continue to Lesson 8",
            onPressed: () {
